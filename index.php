                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                            ...
                            href="index.php?id=<?= $data['id'] ?>&aksi=ubah_status&status=0">
                            Sudah
                            </a>
                        <?php
                        } else {
                        ...
                        <a class="btn btn-warning rounded-pill px-3" type="button"
                            href="index.php?id=<?= $data['id'] ?>&aksi=ubah_status&status=1">
                            Belum
                            </a>
                        <?php
                        }?>
                    ...
                    <td>
                        <a class="btn btn-info rounded-pill px-3" href="index.php?id=<?= $data['id']?>">Ubah</a>
                        <a class="btn btn-danger rounded-pill px-3" href="index.php?id=<?= $data['id'] ?>&aksi=hapus">Hapus
                    </a>
                    </td>
                </tr>
                <?php
